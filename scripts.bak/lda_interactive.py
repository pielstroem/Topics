...
path = os.path.join(os.getcwd(),"../out_off")
...
# load dictionary
print("\n load dictionary \n")
dictionary = Dictionary.load(os.path.join(path,"corpus_off.dict"))

# load corpus
print("\n load corpus \n")
corpus = MmCorpus(os.path.join(path,"corpus_off.mm"))

# load model
print("\n load model \n")
model = LdaModel.load(os.path.join(path,"corpus_off.lda"))
